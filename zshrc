...
# LS_COLORS for zsh completion and Linux ls
...
# LSCOLORS for macOS ls command (BSD format)
if [[ "$OSTYPE" == darwin* ]]; then
  export LSCOLORS=exgxdxdxcxhxhxxbxdxcEh
fi
export EDITOR=vim
...
# Google Cloud SDK (cross-platform)
